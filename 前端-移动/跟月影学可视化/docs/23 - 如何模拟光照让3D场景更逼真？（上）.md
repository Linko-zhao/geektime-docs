...
![](https://static001.geekbang.org/resource/image/05/32/05e0d0ba479de13e7a7df251b27f3332.gif?wh=320%2A248)
...
[![](https://static001.geekbang.org/resource/image/0b/ec/0bb290cca1f160666d0ee2fa2a1edeec.jpeg?wh=1920%2A1080 "平行光示意图")](https://blog.csdn.net/lufy_Legend/article/details/38908403)
...
[![](https://static001.geekbang.org/resource/image/7c/fc/7c0d6511824f6c5c1b2e8d5ebc0d0cfc.jpeg?wh=1920%2A626 "多种反射叠加的效果示意图")](%28https://en.wikipedia.org/wiki/Phong_reflection_model%29)

有向光的漫反射在各个方向上的反射光均匀分布，反射强度与光的射入方向与法线的夹角的余弦成正比。

[![](https://static001.geekbang.org/resource/image/30/07/30955b0fc8785b8157801e3d37155107.jpeg?wh=1920%2A1080)](https://www.photokonnexion.com/definition-diffuse-reflection/)
...
![](https://static001.geekbang.org/resource/image/61/e7/61d3462844c3f3cf6e1978695b9850e7.gif?wh=578%2A528)
...
[![](https://static001.geekbang.org/resource/image/f6/24/f61c6d3fbfd1e9636ffd6604ed2e1a24.jpg?wh=1920%2A1080 "点光源与平行光")](https://subscription.packtpub.com/book/web_development/9781788629690/6/ch06lvl1sec86/time-for-action-directional-point-lights)
...
![](https://static001.geekbang.org/resource/image/69/3b/6901e4792cf5e0dc8572e78f2e1a6c3b.gif?wh=564%2A502)
...
![](https://static001.geekbang.org/resource/image/2e/cd/2efa6ee80cf2cefb41d4c17c8d455acd.gif?wh=518%2A478)

## 如何给物体添加聚光灯效果？

最后，我们再来说说，怎么给物体添加聚光灯效果。

[![](https://static001.geekbang.org/resource/image/1b/58/1b24756ce9ff3252c2566yy312dd5c58.jpg?wh=1920%2A1080 "聚光灯示意图")](http://math.hws.edu/graphicsbook/c7/s2.html)
...
![](https://static001.geekbang.org/resource/image/82/57/8249920558d7c7e444f0f5208f7aa757.gif?wh=540%2A476)
...
<li><span>Geek_00734e</span> 👍（0） 💬（0）<p>const vertex = &#47;* glsl *&#47; `
      precision highp float;
...
不知道我所理解的对不对，疑惑的地方都写在注释里了</p>2022-01-12</li><br/><li><span>Geek_00734e</span> 👍（0） 💬（0）<p>uniform mat4 modelViewMatrix;
uniform mat4 projectionMatrix;
uniform mat4 viewMatrix;
...
modelViewMatrix与viewMatrix有什么区别，为什么法向量跟平行光用的矩阵不一样？为啥要这样做</p>2022-01-12</li><br/><li><span>Geek_00734e</span> 👍（0） 💬（0）<p>precision highp float;
uniform vec3 ambientLight;
uniform vec3 materialReflection;
void main() {  
gl_FragColor.rgb = ambientLight * materialReflection;  
...
两个向量怎么乘嘛</p>2021-04-13</li><br/><li><span>l_j_dota_1111</span> 👍（0） 💬（0）<p>请问方向光、点光源和聚光灯产生的光 前一个物体有可能会挡住后面的物体 导致后面的物体不会又光线，请问这种阴影效果怎么办</p>2021-03-18</li><br/>
</ul>
