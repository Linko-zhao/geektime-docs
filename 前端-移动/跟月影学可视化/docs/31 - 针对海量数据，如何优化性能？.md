...
![](https://static001.geekbang.org/resource/image/ca/4a/caebcea9dd803d01fa4188faf98f9f4a.jpeg?wh=1920%2A1080)
...
![](https://static001.geekbang.org/resource/image/83/78/83f68759c4913bea230fc52d08ac9578.jpeg?wh=1920%2A1080)
...
![](https://static001.geekbang.org/resource/image/10/81/10cc6bc21a8d9d89e06760ddf4118381.jpeg?wh=1920%2A1080)
...
![](https://static001.geekbang.org/resource/image/47/fb/47b1af96385ce25571f0892b1474c6fb.jpeg?wh=1920%2A1080)
...
![](https://static001.geekbang.org/resource/image/62/35/6220f0e98ae2cfc95189df136d59bb35.jpeg?wh=1920%2A1080)
...
![](https://static001.geekbang.org/resource/image/9f/a7/9fa5964587dbb8edf192d3de95c938a7.jpeg?wh=1920%2A1080)
...
![](https://static001.geekbang.org/resource/image/88/2d/886d5b36c0ab94294yy378ab67f0ea2d.gif?wh=480%2A339)
...
![](https://static001.geekbang.org/resource/image/07/d6/07ed4788452a2e214c61fb634fcdd8d6.gif?wh=678%2A480)
...
<li><span>swtgeo</span> 👍（4） 💬（2）<p>请问有没有关于在服务端进行渲染，然后直接将渲染后的图片输出给前端可视化的参考项目实例呢？遥感影像能不能在后端动态切片渲染，然后输出到前端显示呢，省略切片缓存的过程。</p>2020-11-10</li><br/><li><span>木瓜777</span> 👍（1） 💬（1）<p>距离场 能不能 实现 绘制 球 啊？ 如果可以，能不能提供下思路？ 示例中 float d = distance(st, vPos);  其中 vPos 如果是三维坐标 该如何处理？
</p>2020-09-30</li><br/><li><span>我执</span> 👍（0） 💬（1）<p>大佬， 针对 geojson 过大有哪些优化方案呢？
...
最后能想到的还是 针对原始的 geojson 去做处理， 看能不能降低精度。 但是没有找到相应资料， 希望大佬能提供一定解决思路</p>2021-09-23</li><br/><li><span>Zack</span> 👍（0） 💬（1）<p>服务端渲染里没办法使用gpu吧？</p>2020-12-14</li><br/><li><span>Geek_dc1539</span> 👍（0） 💬（0）<p>gl.POINTS 是有大小限制的，绘制大圆有什么高性能的办法吗</p>2023-08-14</li><br/><li><span>东东</span> 👍（0） 💬（0）<p>厉害👍🏻</p>2020-09-11</li><br/>
</ul>
