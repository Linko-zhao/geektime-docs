...
.@{prefix-name}-button {
  ...
  &.@{prefix-name}-button-default-contained {
    ...
    border: 1px solid
      ~"var(--@{prefix-name}-btn-default-contained-border-color)";
  }
  &.@{prefix-name}-button-primary-contained {
    ...
    border: 1px solid
      ~"var(--@{prefix-name}-btn-primary-contained-border-color)";
  }
  &.@{prefix-name}-button-success-contained {
    ...
    border: 1px solid
      ~"var(--@{prefix-name}-btn-success-contained-border-color)";
  }
  &.@{prefix-name}-button-warning-contained {
    ...
    border: 1px solid
      ~"var(--@{prefix-name}-btn-warning-contained-border-color)";
  }
