...
<li><span>尤璐洁</span> 👍（1） 💬（1）<p>老师可以讲讲arguments吗，它是挂在哪里的呢，是个可迭代对象，但是不知道它是哪个的属性</p>2019-11-07</li><br/><li><span>洛克不菲勒</span> 👍（1） 💬（2）<p>for(let e of [1, 2, 3, 4, 5])
    console.log(e);
老师你好，注意到文中有这样的写法，for()后面没有大括号这种写法好吗？
一直都有这样的疑问，if语句也有这样的问题</p>2019-09-11</li><br/><li><span>润群</span> 👍（1） 💬（2）<p>关于switch和ifelse的效率我有个疑问呢，假设ifelse的判断很多，然后判断到末尾才找到匹配的项，这样的话是不是比switch多了好多判断呢，因为我理解的switch不是只判断一次么？</p>2019-06-28</li><br/><li><span>K4SHIFZ</span> 👍（1） 💬（1）<p>请问老师，规范中的Statement和Declaration到底有什么区别？不都是声明的意思吗？</p>2019-04-02</li><br/><li><span>渴望做梦</span> 👍（0） 💬（2）<p>winter老师，这个异步生成器函数是个什么东东啊，从网上搜了一下，也没找到相关介绍。</p>2019-07-29</li><br/><li><span>mfist</span> 👍（74） 💬（2）<p>遍历了下window上面的全局对象，上面有Symbol.iterator的原生属性有15个，主要Array Set Map String相关的。当然还有很多宿主环境提供的全局对象有Symbol.iterator属性，他们有个共同的特征：都是些集合性质的数据结构。
0: &quot;Array&quot;
1: &quot;String&quot;
2: &quot;Uint8Array&quot;
3: &quot;Int8Array&quot;
