...
<li><span>何用</span> 👍（7） 💬（2）<p>UserInfoModalWrapper 考虑 Modal 动画了吗？这种改写不是等价的，会散失动画效果</p>2021-06-18</li><br/><li><span>林斌</span> 👍（5） 💬（2）<p>第一个demo不想展示的话，直接在父级 visible &amp;&amp; &lt;UserInfoModal &#47;&gt; 不就好了吗？ 不知道为什么要多一层嵌套～</p>2021-07-27</li><br/><li><span>知鱼</span> 👍（3） 💬（1）<p>后期会有视频吗？</p>2021-06-18</li><br/><li><span>Free fall</span> 👍（7） 💬（0）<p>做过一个文件预览的功能，根据选中的文件类型，用对应的插件预览</p>2021-06-17</li><br/><li><span>阿禹。</span> 👍（4） 💬（0）<p>antd中表单组件也是有用到render props模式。确实在有些地方很灵活。</p>2021-07-04</li><br/><li><span>ChenQinf</span> 👍（1） 💬（2）<p>render props作用可以理解成vue中的slot吗</p>2022-02-22</li><br/><li><span>Osmond</span> 👍（1） 💬（0）<p>感觉很多UI组件比如说antd 的组件，就很像是用了render props实现了组件的重用吧</p>2021-12-20</li><br/><li><span>与你.</span> 👍（1） 💬（1）<p>学react的时候直接学过hooks， 对于这个render props好像还是不理解</p>2021-06-17</li><br/><li><span>Jackchoumine</span> 👍（0） 💬（0）<p>render props 可用于表中自定义列。</p>2023-06-06</li><br/><li><span>Jun Ma</span> 👍（0） 💬（1）<p>CountRenderProps有点绕。我说下我的理解：
