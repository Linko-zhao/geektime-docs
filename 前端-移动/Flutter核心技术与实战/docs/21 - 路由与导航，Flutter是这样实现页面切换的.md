...
答：1. 使用构造函数传参 2. MaterialPageRoute 加入参数 setting: RouteSettings 。第二个页面获取逻辑和命令路由就一样了。</p>2019-09-03</li><br/><li><span>入魔的冬瓜</span> 👍（2） 💬（1）<p>自己手动push一个route的话，可以通过构造函数进行传参数。
