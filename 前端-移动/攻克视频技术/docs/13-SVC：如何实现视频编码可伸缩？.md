...
<li><span>paradise</span> 👍（1） 💬（1）<p>江哥，问一下，就是svc 编码采用rtp 包封装的形式，实际编码器出来的是普通码流，那这个码流是如何进行rtp svc 封装呢？ 是编码器提前设置好svc 的参考关系，然后从收到第一个I帧开始后就自动更新rtp 包里关于封装svc 编码的相关字段信息吗？</p>2021-12-24</li><br/><li><span>Geek_7de4c5</span> 👍（1） 💬（1）<p>如果是发送端网络不好，时域svc就失效了，有什么好的手段吗？</p>2021-12-21</li><br/><li><span>Geek_wad2tx</span> 👍（1） 💬（2）<p>SVC开始是否有前提，当接收端的方差达到某个阈值时在开启，或者发送端本身发送的帧率或者码率对网络要求很低，例如500k就可以，这时不启用SVC，可以更进一步增加压缩率。</p>2021-12-20</li><br/><li><span>ripple</span> 👍（0） 💬（1）<p>你好，请问下如果是硬编码，svc有相关的处理方式不？</p>2022-03-28</li><br/><li><span>Leo-J</span> 👍（0） 💬（2）<p>老师，这是不是直播推流原理？直播端高质量，观众段可选质量？</p>2022-03-02</li><br/><li><span>ripple</span> 👍（0） 💬（1）<p>simulcast是不是更常用些？</p>2021-12-20</li><br/><li><span>龚长华</span> 👍（0） 💬（0）<p>FEC, Transport-CC, 丢包重传， 关键帧重传， SVC</p>2022-06-08</li><br/><li><span>tony</span> 👍（0） 💬（1）<p>如果使用x264实现时域svc,设置参考帧的大概思路是怎样的？谢谢。</p>2022-01-09</li><br/>
</ul>
