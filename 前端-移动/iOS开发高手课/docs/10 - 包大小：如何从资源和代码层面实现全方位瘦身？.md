...
![](https://static001.geekbang.org/resource/image/47/6b/4746f231258fb5875f72fa594463216b.png?wh=2500%2A1406)
...
![](https://static001.geekbang.org/resource/image/1e/27/1e0b0d270236842f0f1166e107965927.png?wh=1438%2A1038)
...
![](https://static001.geekbang.org/resource/image/40/fc/400835aa1573a15ed4dcbf678bad82fc.png?wh=1024%2A768)
...
![](https://static001.geekbang.org/resource/image/4c/ee/4c0c466cc77f66b14547aaa50bff66ee.gif?wh=660%2A602)
...
![](https://static001.geekbang.org/resource/image/89/45/89d5abb7fdb69a391b75eeba141ecc45.png?wh=1024%2A768)
...
![](https://static001.geekbang.org/resource/image/66/2e/660aebe887ebd20f1b18fc685920b82e.png?wh=1726%2A558)

图8 LinkMap文件获取方法

LinkMap文件分为三部分：Object File、Section 和 Symbols。如下图所示：

![](https://static001.geekbang.org/resource/image/21/07/21cf3a872d3693b1978601b7aa033607.png?wh=1024%2A768)
...
![](https://static001.geekbang.org/resource/image/0b/a4/0bc5431e0cd634296886ac457d4066a4.jpg?wh=2132%2A1328)
...
![](https://static001.geekbang.org/resource/image/a9/11/a935117790e7744069cf1bf58336b711.png?wh=1330%2A1272)

图11 使用 AppCode 来做静态分析

静态分析完以后，我们可以在 Unused code 里看到所有的无用代码，如下图所示：

![](https://static001.geekbang.org/resource/image/57/a4/57a96abafd30d5c15210300c2d1eaba4.png?wh=1632%2A1034)
...
<li><span>元元</span> 👍（30） 💬（2）<p>老师ios为什么要设计元类？能讲一下吗</p>2019-04-02</li><br/><li><span>付海龙</span> 👍（2） 💬（1）<p>相比于2x和3x两套资源，用矢量图一套资源搞定所有，这样会不会更好一点</p>2019-04-02</li><br/><li><span>Toon</span> 👍（1） 💬（3）<p>矢量图呢？也可以减少大小吧</p>2019-04-21</li><br/><li><span>开发小能手</span> 👍（1） 💬（2）<p>请教老师，我在评论中看到老师有提到“元类的flag中记录了什么？”这里的 “flag” 是指isa是一个共用体中每段 “位域” 的含义么？还是指其它的概念？</p>2019-04-13</li><br/><li><span>一纸丶荒年</span> 👍（1） 💬（1）<p>您的这个 工具 对于 swfit  和 xib  不适用.  </p>2019-04-12</li><br/><li><span>卓小土</span> 👍（1） 💬（1）<p>戴老师为什么没有讲一下，用clang AST分析代码依赖关系，找出无用代码的方法。</p>2019-04-12</li><br/><li><span>西北旺车神</span> 👍（1） 💬（1）<p>OTA并不是单指蜂窝网络吧，我觉得是指不用连电脑iTunes下载了</p>2019-04-02</li><br/><li><span>李小草</span> 👍（0） 💬（2）<p>之前开发遇到过提供三方sdk的公司提供了两个版本，一个版本带模拟器指令集（支持模拟器的），一个版本是不带模拟器的，只支持arm真机，上线时切换下，这样可以减小包得体积，请问老师这样对吗？如果这样真能减小包体积的话，那我是不是可以把所有三方sdk中模拟器指令集都剔除掉？</p>2019-06-03</li><br/><li><span>一纸丶荒年</span> 👍（0） 💬（2）<p>你好 我下载了 AppCode 工具. 但是 我选择不了 code-&gt;inspectCode 吖 </p>2019-04-15</li><br/><li><span>Geek_i59t1w</span> 👍（0） 💬（1）<p>framework中的i386和x86_64会打包进release app里么？</p>2019-04-09</li><br/><li><span>付海龙</span> 👍（0） 💬（1）<p>在资源图片上，我都是直接用的2x图，像plus等机型也都是直接找的2x</p>2019-04-02</li><br/><li><span>学无止境</span> 👍（0） 💬（1）<p>添加 xcassets 目录?
Xcode不是自带的有Assets.xcassets吗？
</p>2019-04-02</li><br/><li><span>金子菇凉的铁粉小逗</span> 👍（0） 💬（1）<p>王者荣耀和吃鸡这样的游戏为啥可以几个GB</p>2019-04-02</li><br/><li><span>Geek_97bcf5</span> 👍（73） 💬（9）<p>元类和类的数据结构是同一个，只是运行时使用的字段不一样。
...
所以，问这个问题的，都是objc_msgSend源码没看过的同学。</p>2019-04-03</li><br/><li><span>Mit</span> 👍（5） 💬（0）<p>重复图片与无用图片的检索工具
https:&#47;&#47;github.com&#47;mitchell-dream&#47;MitImgChecker 可以尝试一下这个工具。</p>2019-08-26</li><br/>
</ul>
