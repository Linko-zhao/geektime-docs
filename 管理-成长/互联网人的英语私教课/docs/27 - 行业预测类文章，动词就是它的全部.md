...
> _Mostly this will be_ _**focussed on**_ _the “big five” cloud providers - Amazon, Google, IBM (plus Red Hat), Microsoft, and VMware (plus Pivotal). We think that, outside China, Alibaba will_ **_struggle to gain traction_, as will Oracle, Salesforce, and SAP.**
