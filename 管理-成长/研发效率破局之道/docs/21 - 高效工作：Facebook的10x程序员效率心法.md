...
3. 编译打包部署整个流程，不使用DevOps的话，会有大量的没有什么价值的重复工作。
4. 各种日常报表的生成和维护，可以自己开发程序或者用Excel宏来生成。</p>2019-10-12</li><br/><li><span>兴国</span> 👍（3） 💬（2）<p>代码重复是在写代码时比较反感的地方，常量重复、逻辑重复等都会造成后期的难以维护。
