...
![](https://static001.geekbang.org/resource/image/9b/e8/9bf26739958568453cceeb6f209da2e8.jpg?wh=1142%2A359)

这个NFA还有引入ε转换的画法，它们是等价的。实际上，第二个NFA可以用我们今天讲的算法，通过正则表达式自动生成出来。

![](https://static001.geekbang.org/resource/image/9b/09/9bb22ee26309b3076db53fee34112009.jpg?wh=1142%2A298)
...
![](https://static001.geekbang.org/resource/image/a6/8e/a6af22cdcb96ba92fe9df35bf998768e.jpg?wh=1142%2A600)
...
![](https://static001.geekbang.org/resource/image/0d/ed/0d11ad629f809a94ff091199f27661ed.jpg?wh=1142%2A231)

- 识别i的NFA：

> 当接受字符i的时候，引发一个转换，状态图的边上标注i。

![](https://static001.geekbang.org/resource/image/fe/bc/fe3edc36b5bd69e88eebcd0d28aa4abc.jpg?wh=1142%2A249)
...
![](https://static001.geekbang.org/resource/image/19/95/197071ebe504889264cf8c955d112895.jpg?wh=1142%2A428)

- 转换“st”这样的正则表达式：

> s之后接着出现t，转换规则是把s的开始状态变成st整体的开始状态，把t的结束状态变成st整体的结束状态，并且把s的结束状态和t的开始状态合二为一。这样就把两个子图接了起来，走完s接着走t。

![](https://static001.geekbang.org/resource/image/95/0b/9504b495df0de1cc59ef8d8357c49e0b.jpg?wh=1142%2A339)
...
![](https://static001.geekbang.org/resource/image/40/c5/409d889a2c811221a0cfdd81f32df4c5.jpg?wh=1142%2A363)
...
![](https://static001.geekbang.org/resource/image/a7/07/a753fb42e82341d381c3cbca0247b007.png?wh=782%2A226)
...
![](https://static001.geekbang.org/resource/image/3d/9b/3defa4a1d7ce789b6c6cfecdfbf8179b.jpg?wh=1142%2A528)
...
![](https://static001.geekbang.org/resource/image/9c/f7/9c35bf11efb869c5fa4a22e23de52ff7.jpg?wh=1142%2A551)

将字母i给到s0中的每一个状态，看它们能转换成什么状态，再把这些状态通过ε转换就能到达的状态也加入进来，形成一个包含“3、9、10、13、1”5个状态的集合s1。其中3和9是接受了字母i所迁移到的状态，10、13、1是在状态9的ε闭包中。

![](https://static001.geekbang.org/resource/image/d2/40/d2f3035a3492b680c56777b7fa375e40.jpg?wh=1142%2A496)

在s0和s1中间画条迁移线，标注上i，意思是s0接收到i的情况下，转换到s1：

![](https://static001.geekbang.org/resource/image/58/29/58388daf0627d0bc71efbf7b48401029.jpg?wh=1142%2A728)
...
![](https://static001.geekbang.org/resource/image/be/00/be1a150ce14e828e8e9993b419360e00.jpg?wh=1142%2A375)
...
![](https://static001.geekbang.org/resource/image/b3/ea/b31b50f7b527de9915b81cb7a117c2ea.jpg?wh=1142%2A711)
...
<li><span>刘桢</span> 👍（13） 💬（1）<p>尤雨溪:会编译原理真的可以为所欲为</p>2020-05-14</li><br/><li><span>峰</span> 👍（8） 💬（2）<p>老师：为什么NFA要加空转换这样的操作呢，感觉对表达能力并没有扩展。</p>2019-09-22</li><br/><li><span>漠北</span> 👍（4） 💬（1）<p>感觉很像递归转成动态规划</p>2021-03-30</li><br/><li><span>xindoo</span> 👍（4） 💬（1）<p>https:&#47;&#47;github.com&#47;xindoo&#47;regex  我用java写了个正则引擎，包含了老师这节讲的内容，readme中附了博客，欢迎各位查阅。</p>2020-05-19</li><br/><li><span>维李设论</span> 👍（1） 💬（1）<p>这里的柯林闭包和js中的闭包有什么关系吗？mdn中的定义是函数及其环境的混合，我理解的是js中的闭包是对理算数学中柯林闭包的扩展，推到极致是可以用集合去解释的，不知道我理解的对不对</p>2020-09-16</li><br/><li><span>芒果</span> 👍（1） 💬（1）<p>讲的深入原理，收益匪浅，NFA转DFA可以用子集法</p>2020-01-04</li><br/><li><span>醉雪飘痕</span> 👍（1） 💬（1）<p>请问老师，您的图是用什么工具做得呀？</p>2019-09-22</li><br/><li><span>沉淀的梦想</span> 👍（1） 💬（2）<p>感觉NFA的匹配很适合并行啊，如果对于每个转换条件，开个线程并行匹配，这样就不需要回溯了，是不是能提升不少效率，虽然浪费了一些算力</p>2019-09-22</li><br/><li><span>飞翔</span> 👍（0） 💬（1）<p>老师NFA2DFA这个函数的这一行dfaState = findDFAState(dfaStates, nextStateSet);中的nextStateSet是不是应该是calculatedClosures这个？还有，这一节的代码怎么运行啊，一直编不过</p>2019-09-29</li><br/><li><span>余晓飞</span> 👍（0） 💬（1）<p>文中代码块
int | [a-zA-Z][a-zA-Z0-9]* | [0-9]*
最后一个字符*应该是+
</p>2019-09-28</li><br/><li><span>飞翔</span> 👍（0） 💬（2）<p>老师，这一节的代码怎么运行，GrammarNodeType没有找到定义的地方</p>2019-09-27</li><br/><li><span>Geek_dba6ea</span> 👍（0） 💬（1）<p>第一次从这个层面理解了贪心正则匹配</p>2019-09-21</li><br/><li><span>ifelse</span> 👍（2） 💬（0）<p>理解了一点</p>2022-01-06</li><br/><li><span>bucher</span> 👍（1） 💬（0）<p>如果在dfa中加上通配符点号有什么好方法吗，我是在move里进行修改的，但是这样的话如果有大量正则表达式的时候，nfa转dfa很慢.</p>2019-09-23</li><br/><li><span>风</span> 👍（0） 💬（0）<p>用Python实现了一版RE引擎：
https:&#47;&#47;github.com&#47;killua-killua&#47;RE-Engine

包含了这节课的内容 + 一个手写的 re parser</p>2021-11-02</li><br/>
</ul>
