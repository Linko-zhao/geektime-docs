...
![](https://static001.geekbang.org/resource/image/a8/5c/a815cb2ea9754ae41048668d82ca545c.png?wh=1326%2A688)
...
![](https://static001.geekbang.org/resource/image/91/6b/91329d890437420a2eed55eef713yy6b.jpg?wh=762%2A808)
...
![](https://static001.geekbang.org/resource/image/c7/be/c75e1165db7cafd9979551777cf72ebe.png?wh=1920%2A849)
...
head -n10： 取前10行数据</p>2020-07-01</li><br/><li><span>William</span> 👍（6） 💬（1）<p>ggrep -Po &#39;[\w\.][\w\.\,\-]*\b&#39; 09.words.txt | sort | uniq -c | sort -nr &gt; 09.cnts.txt

找了一篇infoQ的文章实验，开头可能会以 . 开头，如 .NET；</p>2020-07-05</li><br/><li><span>白了少年头</span> 👍（5） 💬（1）<p>我的理解是：正则表达式就像是内功，正则在高级语言和编辑器中的用法就像是外功招式，内功和外功要结合起来使用才能成为武林巅峰！</p>2020-07-01</li><br/><li><span>wenxuan</span> 👍（3） 💬（1）<p>直接统计文章单词频次TOP10：
grep -Po &#39;\w+&#39; article.txt | sort | uniq -c | sort -nr | head -10</p>2020-07-01</li><br/><li><span>134</span> 👍（1） 💬（1）<p>匹配正则：([^\s]+\s)
替换为:$1\n</p>2020-07-02</li><br/><li><span>Bug? Feature!</span> 👍（0） 💬（1）<p>学会正则表达式，可以提高我们的工作效率，这个是毋庸置疑的，跟着老师一起打怪升级！</p>2020-11-08</li><br/><li><span>Robot</span> 👍（0） 💬（1）<p>1、先处理文本为一行一个单词，编辑器为VS code
