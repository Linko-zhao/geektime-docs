...
对于需要使用 N 个字节来表示的字符（N &gt; 1），第一个字节的前 N 位都设为 1，第 N + 1 位设为 0，剩余的 N - 1 个字节的前两位都设位 10，剩下的二进制位则使用这个字符的 Unicode 码点来填充。</p>2021-03-24</li><br/><li><span>天蓬太帅</span> 👍（3） 💬（1）<p>请问例子里有一个表达式是findall(r’(?a)^.$’, ‘学’)，这里面的?a是啥意思？</p>2020-07-19</li><br/><li><span>Blue D</span> 👍（1） 💬（1）<p>python2中的str等同于python3中的bytes类型，
而python2中的unicode等于python3中的str类型</p>2021-10-29</li><br/><li><span>gsz</span> 👍（1） 💬（1）<p>Unicode和gbk编码时，即刻，时间两个词都包含相同的16位数，为什么unicode匹配不了，而gbk的可以匹配？</p>2020-08-20</li><br/><li><span>jooe</span> 👍（1） 💬（2）<p>感谢老师加了 js 的代码示例，对于不会后端语言的还是很友好的</p>2020-07-03</li><br/><li><span>好运来</span> 👍（1） 💬（1）<p> print(u&#39;正&#39;.encode(&#39;utf-8&#39;)) # 全角正则和全角字符串，不能匹配到
print(re.findall(r&#39;＼ｗ＋&#39;, &#39;ａｂｃｄｅｆ&#39;)) # 输出[] # 半角正则和全角字符串，能够匹配到
print(re.findall(r&#39;\w+&#39;, &#39;ａｂｃｄｅｆ&#39;)) # 输出[&#39;ａｂｃｄｅｆ&#39;] # 半角正则和半角字符串，能够匹配到
print(re.findall(r&#39;\w+&#39;, &#39;abcdef&#39;)) # 输出[&#39;abcdef&#39;] # 同上
print(re.findall(r&#39;＼ｄ＋&#39;, &#39;１２３４５６&#39;)) # 输出[]
print(re.findall(r&#39;\d+&#39;, &#39;１２３４５６&#39;)) # 输出[&#39;１２３４５６&#39;]
print(re.findall(r&#39;\d+&#39;, &#39;123456&#39;)) # 输出[&#39;123456&#39;] # 同上
...
</p>2020-06-29</li><br/><li><span>宁悦</span> 👍（1） 💬（1）<p>py3下测试
re.findall(&#39;极客{3}&#39;, &#39;极客客客客气气气&#39;)
结果：[&#39;极客客客&#39;]</p>2020-06-29</li><br/><li><span>盘胧</span> 👍（1） 💬（1）<p>对编码知识一直模棱两可的，顺着这个再梳理一下吧</p>2020-06-29</li><br/><li><span>octopus</span> 👍（0） 💬（2）<p>客重复三次，如果要极客重复三次‘(极客){3}’</p>2021-02-01</li><br/><li><span>Juntíng</span> 👍（0） 💬（1）<p>JS 语言里, 客重复三次，
重复的是最后一个字节的话,将“客”独立为组再进行</p>2020-08-03</li><br/><li><span>岁月轻狂</span> 👍（0） 💬（1）<p>老师，点好通配那里，（？a）是什么意思？</p>2020-07-20</li><br/><li><span>吕伟</span> 👍（0） 💬（1）<p>老师，为什么在sublime text3的正则搜索中输入\p{Han}，没有显示匹配结果。</p>2020-07-20</li><br/><li><span>吕伟</span> 👍（0） 💬（1）<p>极(客){3}</p>2020-07-19</li><br/>
</ul>
