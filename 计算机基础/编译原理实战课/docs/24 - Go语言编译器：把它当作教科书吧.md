...
![](https://static001.geekbang.org/resource/image/1e/4c/1e0b9ae47048ed77329d941c4a8e374c.jpg?wh=1110%2A788)
...
![](https://static001.geekbang.org/resource/image/a8/66/a8c648560c0b03b23c3b39a95cbd5b66.jpg?wh=1920%2A654)

图2：foo示例程序各个处理阶段的IR

针对第一个阶段（Start阶段），我来给你解释一下每行指令的含义（可参考genericOps.go），帮助你了解Go语言的IR的设计特点。

![](https://static001.geekbang.org/resource/image/b1/a5/b1d104eaac5d7f04a3dc59f7a6d2a2a5.jpg?wh=2284%2A2949)
...
![](https://static001.geekbang.org/resource/image/yy/f8/yy0a23bdf773d2yy1d7234d95578eff8.jpg?wh=1920%2A719)
...
![](https://static001.geekbang.org/resource/image/c0/fb/c091e058e96d6f166fa5737b8d9a80fb.jpg?wh=1438%2A186)
...
![](https://static001.geekbang.org/resource/image/60/93/60798f64cbcd63d45671412712b49893.jpg?wh=1234%2A876)
...
![](https://static001.geekbang.org/resource/image/b4/47/b4d6d2e094c9d2485303065945781047.jpg?wh=2284%2A2521)
...
<li><span>Geek_a71358</span> 👍（2） 💬（1）<p>老师您好，有个问题想请教您下，我想在golang上面实现一个wasm的aot执行器，是不是把wasm翻译为go的IR，然后复用go的编译器代码就可以了，主要是执行器想在golang上做不想走cgo</p>2020-08-26</li><br/><li><span>Geek_02b7e6</span> 👍（1） 💬（1）<p>指令排序不受重视的真正原因是没有准确的性能度量模型。不仅仅是指令调度，很多基于解析模型的传统编译器优化正在一头撞到这堵墙上。gcc在x86上的性能改进几年加起来也就2%。。。
cpu的动态调度能力强大并不是不做静态调度的理由，静态调度和动态调度是互补而不是冲突的。</p>2020-08-21</li><br/><li><span>fy</span> 👍（0） 💬（1）<p>老师，那些不同语言得编译器，你用的是JB(JetBrains)全家桶嘛</p>2021-04-09</li><br/><li><span>小豹哥</span> 👍（1） 💬（0）<p>文章质量太TM硬了，牙齿都掉了好几个</p>2022-06-27</li><br/><li><span>Tintin</span> 👍（1） 💬（2）<p>请问下老师，能否出了一个使用GoLand调试go编译器的指引呢？折腾了好久没有折腾成功</p>2020-11-14</li><br/><li><span>VoiceWitness</span> 👍（0） 💬（0）<p>老师， 在一课一思的部分 除了思考题之外，能否再给我们布置一些基础题 ，在实践问题的过程中消化学到的知识； 现在像拥有了海克斯科技 但不知道怎么使用</p>2022-10-12</li><br/><li><span>kkxue</span> 👍（0） 💬（0）<p>阅读Go源码中，很棒的指引！</p>2022-06-17</li><br/>
</ul>
