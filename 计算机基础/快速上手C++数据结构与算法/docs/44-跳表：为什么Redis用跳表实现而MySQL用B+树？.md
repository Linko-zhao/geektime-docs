...
![](https://static001.geekbang.org/resource/image/a3/13/a3834958a328e869e4df4119e3dbb513.jpg?wh=2452x252 "图1 普通的有序单链表")

对于图1，如何进行优化来减少它的时间复杂度呢？我们给上述链表添加一级索引，如图2所示：

![](https://static001.geekbang.org/resource/image/55/d8/55f83d407534c61c61bc2456ba0658d8.jpg?wh=2438x552 "图2 增加了第一级索引的单链表")
...
![](https://static001.geekbang.org/resource/image/13/43/138eff4408bfc92a28382b4488c2f843.jpg?wh=2452x836 "图3 增加了第二级索引的单链表")
...
![](https://static001.geekbang.org/resource/image/7e/31/7eb3ef9766a63e48002a40c560131031.jpg?wh=2498x867 "图4 增加了第二级索引后查找元素9所要经过的路径（加粗）")
...
![](https://static001.geekbang.org/resource/image/bd/23/bd3cc57acac90c373fc9f4e4a3d03423.jpg?wh=1458x524 "图5  只包含头结点的跳表（相当于空跳表或者可以认为目前只是个空链表）")

当分别插入数据3、1、7、6时，跳表就会如下图6的子图1到子图4所示：

![](https://static001.geekbang.org/resource/image/d7/94/d75be98bd8afcda30ae7db219e221a94.jpg?wh=2691x1506 "图6  插入了节点3、1、7、6后的跳表表现")
...
![](https://static001.geekbang.org/resource/image/42/93/425a22f0c7dc2e352637636395230593.jpg?wh=2207x855 "图7  继续插入节点9后的跳表表现")
...
![](https://static001.geekbang.org/resource/image/c0/ef/c0eeb31bce7ea12630da6ffa6f9469ef.jpg?wh=2524x1184 "图8 继续插入节点5后的跳表表现")
...
![](https://static001.geekbang.org/resource/image/3a/bd/3a3e68bd18b4e47222f3d0558da4c1bd.jpg?wh=2292x1158 "图9 删除节点5后的跳表外观（注意粗线代表寻找节点的路线）")
...
![](https://static001.geekbang.org/resource/image/2c/2f/2cea850c63f75953f73b84c24fe0f32f.jpg?wh=2280x1137 "图10 删除节点7后的跳表外观（注意粗线代表寻找节点的路线）")
