...
&#47;** Sequence关于取值是直接Get(), 查看内部方法直接返回value * * Atomically add the supplied value. * * @param increment The value to add to the sequence. * @return The value after the increment.
*&#47;
public long addAndGet(final long increment)
{
long currentValue;
...
&#47;** AtomicLong关于取值时使用getLongVolatile，查看其源码，增加了Volatile和自旋锁 * * getAndAddLong *
*&#47;
