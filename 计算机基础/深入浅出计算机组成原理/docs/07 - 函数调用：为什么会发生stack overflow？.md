...
![](https://static001.geekbang.org/resource/image/dc/85/dca83475560147d4dd492ff283ae0c85.jpeg?wh=2035%2A1381)
...
<li><span>kdb_reboot</span> 👍（59） 💬（8）<p>倒数第二图比较好 
补充一下寄存器说明
rbp - register base pointer (start of stack)
rsp - register stack pointer (current location in stack, growing downwards)
建议将图编号这样评论的时候也能有所指代</p>2019-05-10</li><br/><li><span>chengzise</span> 👍（46） 💬（2）<p>老师这里需要补冲一下，函数调用call指令时，（PC）指令地址寄存器会自动压栈，即返回地址压栈，函数返回ret指令时会自动弹栈，即返回地址赋值给PC寄存器，把之前。图片有显示压栈，没有文字说明，其他同学可以不太理解。</p>2019-05-10</li><br/><li><span>秋天</span> 👍（30） 💬（2）<p>现在有点模糊的是栈只是用来做函数调用，记录跳转地址的？它和寄存器的本质区别吗？这两者能给解释一下吗？谢谢！</p>2019-05-27</li><br/><li><span>Better me</span> 👍（20） 💬（5）<p>push rbp；
mov rbp rsp；
老师，想问这两句是如何控制函数调用的</p>2019-05-10</li><br/><li><span>蚂蚁内推+v</span> 👍（17） 💬（2）<p>老师 巨大数组为什么是分配在栈空间的呢？（java里面是分配到堆上的 c预约和java不同吗）</p>2019-06-06</li><br/><li><span>Allen</span> 👍（17） 💬（2）<p>int main()
{
   d:   55                      push   ebp
   e:   89 e5                   mov    ebp,esp
...
希望老师解答下，非常感谢！！！</p>2019-05-10</li><br/>
</ul>
