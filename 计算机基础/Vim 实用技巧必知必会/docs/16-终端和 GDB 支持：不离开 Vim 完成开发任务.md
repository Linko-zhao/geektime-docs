...
<li><span>前端西瓜哥</span> 👍（1） 💬（1）<p>老师，怎么在vimrc设置默认shell啊，Windows 下我每次打开默认打开的是 cmd，我想用的是 powershell，每次打开都要敲 :term powershell，命令有点长（当然我也想到一个解决方案是加个快捷方式 \t</p>2020-09-16</li><br/><li><span>我来也</span> 👍（1） 💬（1）<p>学习了.
有时间了再好好研究研究.
...
不知不觉专栏的正文部分都结束了，不舍。������
</p>2020-09-09</li><br/><li><span>谁家内存泄露了</span> 👍（0） 💬（2）<p>请问老师，在vim内置的终端里，如果我想输入上一条命令，怎么实现呢？普通终端应该使用方向键↑就好了。</p>2023-03-12</li><br/><li><span>唐龙</span> 👍（0） 💬（1）<p>首先体验了一下`:tab term`的无限递归，我一直都挺喜欢用多个标签页的。
...
感觉自己还可以进一步的做些定制，主要是快捷键，到时候再假装vim是IDE，奈斯。</p>2020-09-09</li><br/><li><span>doge</span> 👍（0） 💬（1）<p>学到了，单文件调试效果确实不错。不过大型项目的调试感觉不是特别好用了。</p>2020-09-09</li><br/>
</ul>
