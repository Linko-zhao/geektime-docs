...
示例的 Git 库里的指定标签上仍然是老的代码。最新的代码则已经调整过。</p>2020-10-25</li><br/><li><span>pyhhou</span> 👍（5） 💬（1）<p>赞，理清了 vim 的文件和配置架构，以及 .vim 文件的由来。
...
</p>2020-08-04</li><br/><li><span>分清云淡</span> 👍（4） 💬（1）<p>求问老师，文章中的 gif 动图有什么工具制作的，特别是动图中 大大的按键提示。多谢</p>2020-08-02</li><br/><li><span>奕</span> 👍（3） 💬（2）<p>怎么查看 runtimepath 这个环境变量的？直接 echo 出来是空的</p>2020-08-02</li><br/><li><span>大狗爱吃鱼</span> 👍（2） 💬（1）<p>PackUpdate命令后等很久很久，也没有安装好，请问下这是怎么回事啊？</p>2020-10-18</li><br/><li><span>JRTx</span> 👍（1） 💬（1）<p>每次执行PackUpdate，GVIM下方就会提示&quot;Minpac has not been initialized. Use the default val Press ENTER or type command to continue&quot;
系统环境：Windows 7 旗舰版
VIM版本：8.2.1845
...
对Vimscript不熟悉，希望老师能够指正。</p>2020-10-20</li><br/><li><span>__@948CSheLL</span> 👍（1） 💬（1）<p>老师您好，请问vim中的菜单是什么，我该如何在vim中显示出菜单？</p>2020-08-13</li><br/><li><span>极客酱酱</span> 👍（0） 💬（1）<p>eunuch.vim插件很实用
