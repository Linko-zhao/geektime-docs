...
![](https://static001.geekbang.org/resource/image/0b/b6/0b241afef775a1c942c5728364b302b6.jpg?wh=2200%2A2262)
...
<li><span>公告-SRE运维实践</span> 👍（113） 💬（6）<p>分地址和运营商主要是为了返回最优的ip，也就是离用户最近的ip，提高用户访问的速度，分运营商也是返回最快的一条路径。gslb失灵一般是因为一个ns请求gslb的时候，看不到用户真实的ip，从而不一定是最优的，而且这个返回的结果可能给一个用户或者一万个用户，可以通过流量监测来缓解。</p>2018-08-19</li><br/><li><span>Garwen</span> 👍（36） 💬（3）<p>刘超老师，根域名服务器的访问不还是无法逃离高并发访问的场景吗，虽说本地的DNS已经可以解决80%请求的地址解析，但还是会有极其庞大数量的访问需要去找根域名服务器的吧，这里的根域名服务器的高并发场景不比12306小吧，是如何解决的呢？</p>2019-05-05</li><br/><li><span>古夜</span> 👍（14） 💬（1）<p>这一课看懂了，还联想到了ping百度域名有时候返回ip不一样的问题，感谢</p>2019-04-19</li><br/><li><span>jim</span> 👍（14） 💬（3）<p>浏览器，路由器也有缓存吧？</p>2018-11-28</li><br/><li><span>alexgzh</span> 👍（13） 💬（1）<p>以前只知道DNS是方便記憶。今天學到了DNS其實是解耦應用和被訪問應用的IP地址，還有局部負載均衡和全局負載均衡的功能, 學到了！！</p>2019-07-20</li><br/><li><span>杨春鹏</span> 👍（11） 💬（3）<p>当访问网站的时候，是先去访问host文件还是，本地DNS缓存？</p>2018-09-12</li><br/><li><span>胸怀宇宙瓜皮李</span> 👍（8） 💬（1）<p>确实不是很理解为什么需要两次的全局负载均衡？为什么不在第一次的负载均衡中，直接获取DNS服务器所在地址和DNS服务提供商？</p>2019-07-14</li><br/><li><span>刘培培</span> 👍（6） 💬（1）<p>1. 不同地区和运营商之间延迟不同，所以优先选择同运营商、同地区服务

2. GLSB 挂掉了，客户端地址、运营商变更了，缓存未及时更新。</p>2019-08-27</li><br/><li><span>魔兽rpg足球</span> 👍（6） 💬（7）<p>引用原文中的话：
