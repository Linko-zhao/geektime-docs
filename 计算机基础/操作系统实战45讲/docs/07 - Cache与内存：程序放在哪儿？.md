...
![](https://static001.geekbang.org/resource/image/97/bd/976f5cf91bc656e2a876235a5d2efabd.jpg?wh=2805%2A2805 "x86 CPU的Cache结构图")
...
![](https://static001.geekbang.org/resource/image/d4/y0/d43c10bbb1a1159d9da7d3b14a3cfyy0.jpg?wh=3145%2A3450)

## 思考题

请你思考一下，如何写出让CPU跑得更快的代码？由于Cache比内存快几个数量级，所以这个问题也可以转换成：如何写出提高Cache命中率的代码？
<div><strong>精选留言（15）</strong></div><ul>
<li><span>数学汤家凤</span> 👍（19） 💬（2）<p>程序代码优化 基于csapp做的整理 https:&#47;&#47;blog.csdn.net&#47;u013570834&#47;article&#47;details&#47;117635229?utm_source=app&amp;app_version=4.9.2
...
5. 根据阿姆达尔定律，加速大的部分永远比加速小的要有效，所以我们可以根据对程序的分析来做具体的优化</p>2021-06-28</li><br/><li><span>neohope</span> 👍（271） 💬（10）<p>如何写出让 CPU 跑得更快的代码？可以从以下几方面入手：
...
10、直接使用昂贵的寄存器作为变量，可以变相提供加速效果；</p>2021-05-24</li><br/><li><span>zhanyd</span> 👍（25） 💬（1）<p>我以前写过一篇关于缓存局部性原理的文章，有兴趣的同学可以看看：
https:&#47;&#47;blog.csdn.net&#47;zhanyd&#47;article&#47;details&#47;102631248</p>2021-05-24</li><br/><li><span>pedro</span> 👍（62） 💬（15）<p>在CSAPP第六章对存储器层次架构有详细的探讨，感兴趣的同学可以查阅一下，这里我简单总结一下当做思考题答案。
