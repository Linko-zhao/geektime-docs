...
![](https://static001.geekbang.org/resource/image/c2/d5/c23a69ea88eda1644df17b734df491d5.png?wh=2028%2A862)
...
<li><span>回到原点</span> 👍（2） 💬（1）<p>def search_ext(file_ext):
    with open(dbfile, encoding=&#39;utf-8&#39;) as f:
        for line in f.readlines():
...
if **name** == &quot;**main**&quot;:
search_ext(&#39;.jpg&#39;)</p>2021-03-28</li><br/><li><span>Geek_cdcb96</span> 👍（0） 💬（1）<p>def write_to_db():  
&quot;&quot;&quot; 写入索引文件 &quot;&quot;&quot;  
current_path = pathlib.PurePath(**file**).parent  
dbfile = current_path.joinpath(&quot;search.db&quot;)  
with open(dbfile, &#39;w&#39;, encoding=&#39;utf-8&#39;) as f:
for r in result:  
f.write(f&quot;{str(r)}\n&quot;)
...
还有一个问题，我使用locate_file()函数对文件较多的目录进行搜索时，显示直接跳出了，没有返回目录中的文件，但是在命令行条件下可以返回。是怎么回事。</p>2022-05-28</li><br/><li><span>Soul of the Dragon</span> 👍（0） 💬（3）<p>老师，我按照您之前说的，用.py格式的脚本文件运行“current_path = pathlib.PurePath(**file**).parent”这一行代码，为什么还是会出现“NameError: name &#39;**file**&#39; is not defined”这样的报错？</p>2021-03-02</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<p>学习打卡</p>2023-07-08</li><br/><li><span>琥珀·</span> 👍（0） 💬（0）<p>expanded_name = &quot;jpg&quot;

with open(dbfile, encoding=&#39;utf-8&#39;) as f:
for line in f.readlines():
if re.search(f&quot;.*{expanded_name}&quot;, line, flags=re.IGNORECASE):
print(line.rstrip())</p>2021-03-14</li><br/>
</ul>
