...
<li><span>panda_dou</span> 👍（0） 💬（2）<p>请问一下，文章中代码的GitHub的链接可以提供一下吗？</p>2023-08-07</li><br/><li><span>peter</span> 👍（0） 💬（1）<p>请问：“共现矩阵”就是“协同过滤矩阵”吗？</p>2023-06-08</li><br/><li><span>叶圣枫</span> 👍（0） 💬（1）<p>这些表里的数据从哪里来？
self.mongo = MongoDB(db=&#39;recommendation&#39;)        
self.db_client = self.mongo.db_client        
self.read_collection = self.db_client[&#39;read&#39;]        
self.likes_collection = self.db_client[&#39;likes&#39;]        
self.collection = self.db_client[&#39;collection&#39;]        
self.content = self.db_client[&#39;content_labels&#39;]</p>2024-02-15</li><br/><li><span>悟尘</span> 👍（0） 💬（0）<p>read_count = self.read_collection.find(query).count() 执行报错 AttributeError: &#39;Cursor&#39; object has no attribute &#39;count&#39;:
