...
不过，实际Task分配给哪个服务器执行，却不是由Master来决定的。Borg把这部分职责单独从Master里剥离出来，给了一个叫做**Scheduler的服务器**。当一个Job提交给Master之后，Master会把它变成一个个有待调度的Tasks，然后加入到一个队列里。而我们的Scheduler则会异步遍历这些Tasks，当它判断我们的集群有足够的资源，可以满足整个Job的需求的时候，它就会把Task分配到Slave服务器里。
...
![](https://static001.geekbang.org/resource/image/0a/98/0a7891439a757e6ede6d00583e78dd98.jpg?wh=2000x1542 "论文中的图1，Borg的整体架构")
...
<li><span>张耒</span> 👍（1） 💬（0）<p>为啥说是电力成本呢 文章是在讨论资源合理利用，避免闲置的情况  这种应该耗电量更大吧 ？ 辛苦老师解答</p>2023-06-09</li><br/><li><span>hadoop_admin</span> 👍（0） 💬（0）<p>服务器多的话，监控、心跳都是问题</p>2022-02-21</li><br/><li><span>csyangchsh</span> 👍（0） 💬（1）<p>1 万台服务器的额外挑战能想到的有两个：网络和机器故障。</p>2022-01-10</li><br/><li><span>那时刻</span> 👍（0） 💬（3）<p>请问老师，CGroup进行资源的限制和权限的隔离，而namespace也有权限的隔离，它们的区别是什么呢？</p>2022-01-07</li><br/>
</ul>
