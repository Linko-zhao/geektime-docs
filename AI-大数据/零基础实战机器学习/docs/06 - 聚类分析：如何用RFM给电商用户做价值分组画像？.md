...
<li><span>Jove</span> 👍（34） 💬（3）<p>1、绘制三维图
...
2、我从事的行业的是信贷，也可以从用户征信情况、借贷金额、违约次数等来聚合为用户划分评级</p>2021-09-14</li><br/><li><span>吴悦</span> 👍（14） 💬（1）<p>多维数据输入时怎么做 无量纲化好呀</p>2021-09-10</li><br/><li><span>吃鱼</span> 👍（6） 💬（2）<p>我把 R、F、M 三个特征同时输入 K-Means 算法，并与文中提到的先分别聚类再求和两种方法进行比较，结果如下：
