...
![图片](https://static001.geekbang.org/resource/image/d9/12/d9b5155a6f8e311a504c46383011de12.png?wh=2010x1135 "一个能观察环境的 GPT（Camera 打开）正在告诉另一个 GPT（Camera 未打开）它看到了什么")
