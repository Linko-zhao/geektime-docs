...
Langchian有那么的不堪吗？不过好像也没看到此文中介绍的内容超越或者颠覆LangChain多少...保持技术的中立性和客观性</p>2023-10-03</li><br/><li><span>顾琪瑶</span> 👍（4） 💬（1）<p>1. 设定基础信息, 如姓名, 年龄, 职业, 家庭等等 2. 背景故事 3. 行为准则 4. 环境信息(如所处的地方, 工作场地等等)
