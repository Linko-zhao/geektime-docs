...
<li><span>可怜大灰狼</span> 👍（2） 💬（1）<p>1.密钥固定不变
2.密钥定期变化，但是没用初始化向量
3.用上了初始化向量，但是这个向量是固定值
4.没用MAC，没用AEAD
完了，完了，该犯的问题，都有了。</p>2020-12-28</li><br/><li><span>韩露</span> 👍（1） 💬（2）<p>AEAD 模式能跟国密算法结合吗？现在都在提倡国产化，如果不能跟国密算法结合，还是用不了AEAD模式。</p>2021-01-06</li><br/><li><span>奕</span> 👍（0） 💬（4）<p>老师，后面讲完 非对称加密，可以再来个密码学应用实战，把这些理论知识实践上</p>2022-08-12</li><br/><li><span>harryZ</span> 👍（0） 💬（2）<p>对于国密老师什么时候开个专题</p>2022-05-23</li><br/><li><span>Litt1eQ</span> 👍（3） 💬（1）<p>想到了802.11当中的wep算法采用了24位的初始化向量与同一把密钥进行运算 从而导致了严重的安全问题</p>2020-12-28</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<p>初始化向量的重复问题，就是使用 AEAD 算法的最大风险，也是最难处理的风险。--记下来</p>2022-11-10</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<p>学习打卡</p>2022-11-10</li><br/>
</ul>
