...
ImportError: cannot import name &#39;GPTFaissIndex&#39; from &#39;llama_index&#39; (&#47;usr&#47;local&#47;lib&#47;python3.10&#47;dist-packages&#47;llama_index&#47;**init**.py)</p>2023-05-15</li><br/><li><span>haha</span> 👍（0） 💬（1）<p>PaLM2呢，今天被公众号刷屏了</p>2023-05-11</li><br/><li><span>Geek_9znsx3</span> 👍（0） 💬（1）<p>在colab运行11_colab_chatglm_opensource.ipynb，安装python包时报错，protobuf包版本冲突，请问这个怎么解决？从报错信息看是由于tensorflow-2.12.0依赖protobuf3.20.3，但是icetk-0.0.7依赖 protobuf-3.18.3
...
报错：
&#47;usr&#47;local&#47;lib&#47;python3.10&#47;dist-packages&#47;faiss&#47;**init**.py in replacement_add(self, x)
212
213 n, d = x.shape
--&gt; 214 assert d == self.d
