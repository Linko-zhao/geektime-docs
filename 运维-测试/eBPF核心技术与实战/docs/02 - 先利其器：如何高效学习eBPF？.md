...
<li><span>莫名</span> 👍（36） 💬（11）<p>曾基于 BPF 做过一个容器平台的链路追踪系统，分解出单个请求在服务端经过的节点、网络设备、耗时等信息，便于快速定位网络抖动时主要延迟的具体发生点。
...
如果公司的环境暂时还不能应用 BPF 技术，不妨碍先进行知识储备，自己先玩起来，等到真正被需要的时候就可以发挥作用了。</p>2022-01-19</li><br/><li><span>吃苹果的考拉</span> 👍（13） 💬（5）<p>从倪老师的linux性能篇，了解到了ebpf，就买了《bpf之巅》自学了一阵，现在居然倪老师也出了ebpf的课程，果断入手，希望认识能更上一个台阶</p>2022-01-19</li><br/><li><span>ranger</span> 👍（7） 💬（1）<p>正在接触混沌工程和其中一款开源产品chaos-mesh，一个基于bpf实现的内核故障注入的模块bpfki</p>2022-01-30</li><br/><li><span>includestdio.h</span> 👍（2） 💬（2）<p>第一次接触bpf是通过老师的 linux性能优化专栏，然后看到老师有推荐性能之巅这本书，果断入手并断断续续看完了，目前实际工作中还没有接触过ebpf，因此也无从入手，希望通过专栏能收获更多</p>2022-01-19</li><br/><li><span>秋名山犬神</span> 👍（1） 💬（2）<p>想知道下k8s中的哪些功能是老师贡献的</p>2022-01-24</li><br/>
</ul>
