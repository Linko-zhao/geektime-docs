...
![](https://static001.geekbang.org/resource/image/fe/d7/fe51f9e6ec935017ccf71a3fa4d834d7.png?wh=1700%2A576)
...
![](https://static001.geekbang.org/resource/image/3c/c4/3c9493c583ecf38ed9e0b96fe18494c4.png?wh=1830%2A830)
...
![](https://static001.geekbang.org/resource/image/64/78/6405e04c8bd17315060485857336d078.png?wh=1830%2A467)
...
![](https://static001.geekbang.org/resource/image/2a/5a/2a0dbc3d50efdb6993a7839c8a7fb35a.png?wh=1831%2A581)
...
![](https://static001.geekbang.org/resource/image/94/7e/94e40d9e66ca3dd35dd1140fa5fdfb7e.png?wh=1826%2A454)
...
![](https://static001.geekbang.org/resource/image/7a/ac/7aa61af1bf6a89c2d525d6a4538e25ac.png?wh=5996%2A7976)
...
![](https://static001.geekbang.org/resource/image/9e/c3/9ecd0a5d86f6d9c9d3723e943b8e14c3.png?wh=1825%2A580)
...
![](https://static001.geekbang.org/resource/image/f3/16/f3caebb33d1b4274df8bbdf696fbed16.png?wh=1832%2A831)
...
![](https://static001.geekbang.org/resource/image/ef/e8/ef514de33b59cc1eca4fb29bb39eaee8.png?wh=1904%2A531)
...
![](https://static001.geekbang.org/resource/image/68/f9/6877fa4a920aa988a08b3db3b1a63bf9.png?wh=1865%2A678)

我们看到，所有的insert都在LOCK WAIT状态了，这就是表级锁对insert产生的影响。如果你再查一下锁和锁等待的话，就会看到如下信息：

![](https://static001.geekbang.org/resource/image/4f/4d/4f790e6fa173ddbf2172ee11ef42c74d.png?wh=1488%2A707)
...
![](https://static001.geekbang.org/resource/image/8b/9c/8b4d2ea1d59309d1467be3c236f2039c.png?wh=1419%2A753)
...
![](https://static001.geekbang.org/resource/image/0d/68/0d63c40c3a5c25177807fa3612437d68.png?wh=1830%2A582)
...
<li><span>徐峥</span> 👍（0） 💬（1）<p>高老师，您好。在您看来扩容除了需要前期的优化之外，还需要遵循哪些原则？</p>2022-06-10</li><br/><li><span>不将就</span> 👍（0） 💬（1）<p>老师，您在第五步写的最后的大招是扩容，但是当前的资源没用上呢，为什么要扩容呢？没理解这里</p>2021-10-27</li><br/><li><span>Alisa</span> 👍（0） 💬（1）<p>老师，我的思路是这样：
1.使用jmap可以查看消耗内存占比，对消耗内存占比较大的方法进行分析。
   比如数据库查询结果太大，存入内存会消耗大量内存；或者循环调用；
2.TPS上不去，资源也用不上的时候，分析响应时间。找出响应时间长的节点，时间消耗在哪里，在干什么从而根据情况继续分析</p>2021-06-07</li><br/><li><span>Geek_xbye50</span> 👍（0） 💬（2）<p>高老师问下时序图的插件是啥？</p>2021-05-10</li><br/><li><span>alley</span> 👍（0） 💬（1）<p>我们性能测试，资源使用率不超过80%都算正常，这样是不是大有危险。</p>2021-05-07</li><br/><li><span>zuozewei</span> 👍（2） 💬（0）<p>日志响应时间配置可以参考本文：https:&#47;&#47;mp.weixin.qq.com&#47;s&#47;JeKdirFrM5LGAqZrrdKoXA</p>2021-05-08</li><br/>
</ul>
