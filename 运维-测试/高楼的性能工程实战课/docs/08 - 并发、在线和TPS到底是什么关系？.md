...
老师 全新的系统怎么办？</p>2021-06-03</li><br/><li><span>大白</span> 👍（3） 💬（1）<p>用户级操作的完整业务流时间（记得多采样一些数据，计算平均时间）。这个值也是从日志中取到；
...
</p>2021-08-27</li><br/><li><span>byyy</span> 👍（1） 💬（1）<p>老师，我有2个问题，帮我解答下
1.&quot;在线用户数。这个值可以从日志中取到；&quot;
