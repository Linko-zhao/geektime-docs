...
<li><span>ifelse</span> 👍（1） 💬（0）<p>学习打卡</p>2023-03-30</li><br/><li><span>peter</span> 👍（0） 💬（0）<p>请教老师一个问题啊：
Q1：怎么控制浏览器的加载顺序？
期望顺序：浏览器先从自己的缓存中读取某个文件 ---》 浏览器缓存没有该文件，到CDN去读取该文件 ---》CDN没有该文件，到服务器读取。  这个顺序怎么控制？ 是通过http响应头控制吗？</p>2022-03-05</li><br/>
</ul>
