...
args: - --ip-masq - --kube-subnet-mgr - --iface=enp0s3 &#47;&#47; 这里替换成自己的网卡</p>2023-01-08</li><br/><li><span>大毛</span> 👍（5） 💬（2）<p>对于使用 virtualBox 搭建环境，无法使用 DNS 和 exec 进入容器内部的同学，这里有我解决问题的方法，可以尝试参考一下。
