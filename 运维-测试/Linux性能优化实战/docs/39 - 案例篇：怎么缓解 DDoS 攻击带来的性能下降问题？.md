...
<li><span>怀特</span> 👍（29） 💬（3）<p>这个专栏太超值，我跟追剧一样的追到现在，收获已经巨大！
谢谢倪工的分享。
更谢谢倪工对留言一丝不苟的回复---这份对听众的耐心，其他专栏的作者没有一个能比得上的。
继续追剧！</p>2019-02-21</li><br/><li><span>ichiro</span> 👍（15） 💬（2）<p>最近服务会出现干核现象，一个单进程程序发现把一个cpu耗尽，用top发现一个cpu的，软中断很高，通过watch -d cat &#47;proc&#47;softireq，发现网络中断很高，然后配置多网卡队列，把中断分散到是他cpu，缓解了进程cpu的压力，但同时带来担忧，配置多网卡队列绑定，会不会带来cpu切换，缓存失效等负面影响？另外，老师还有别的建议吗？</p>2019-02-27</li><br/><li><span>李燕平</span> 👍（13） 💬（1）<p>服务器插上网线就像开车上路。

DDoS攻击可以理解为撞车，提升汽车本身的安全系数会有用。
大量DDoS攻击可以理解为撞上大货车，需要护卫车队来保护主车。
</p>2019-02-20</li><br/><li><span>明翼</span> 👍（11） 💬（1）<p>检测DDOS攻击，我没有什么这方面经验想了下：
