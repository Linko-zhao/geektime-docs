...
<li><span>壬大师</span> 👍（1） 💬（1）<p>老师，python能开发手机游戏吗，游戏引擎用的是pygame吗？</p>2018-06-11</li><br/><li><span>@浩</span> 👍（1） 💬（1）<p>用QT写窗口如何，MFC有点晦涩难懂。</p>2018-06-09</li><br/><li><span>立春</span> 👍（1） 💬（1）<p>C++用的是MFC了……</p>2018-06-09</li><br/><li><span>宋桓公</span> 👍（0） 💬（1）<p>最大化，加无边框等于全屏</p>2018-06-27</li><br/><li><span>壬大师</span> 👍（0） 💬（1）<p>老师，那手游的开发目前也都是C++咯？像简单游戏比如手机棋牌类游戏一般用什么语言？</p>2018-06-13</li><br/><li><span>呵呵</span> 👍（0） 💬（1）<p>用c++建立窗体，默认用的什么图形库？</p>2018-06-09</li><br/><li><span>Geek_King@技术爱好者</span> 👍（10） 💬（0）<p>c++窗口那段程序，编译时需加上-mwindows或者-lgdi32,又或者在建工程的时候选择建立gui程序🙄🙄🙄</p>2018-06-15</li><br/><li><span>GS</span> 👍（4） 💬（0）<p>python3 要用小写的tkinter</p>2018-07-28</li><br/><li><span>呵呵</span> 👍（4） 💬（0）<p>要是能提供远嘛就好了，跟着后面敲太麻烦</p>2018-06-09</li><br/><li><span>清新灬小柠檬</span> 👍（1） 💬（0）<p>直接将显示器的大小当作参数传到绘制窗体的函数中？</p>2019-06-24</li><br/><li><span>白马</span> 👍（1） 💬（0）<p>是调用windows api中获取当前屏幕窗口尺寸的方法获得吗？</p>2018-06-09</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<p>学习打卡</p>2024-03-15</li><br/><li><span>Geek_569f22</span> 👍（0） 💬（0）<p>windows那个照着输入，生成不了窗口，python那个可以</p>2021-06-16</li><br/><li><span>Leolee</span> 👍（0） 💬（0）<p>python3导入模块要改小写，调用tk库的方法时也要改小写，就可以用了。一开始还担心要c++等一堆软件。</p>2021-04-20</li><br/><li><span>louis</span> 👍（0） 💬（0）<p>把窗体的大小设置为屏幕大小，设置屏幕的起始位置设置为（0，0）吗？具体调用什么函数不清楚。</p>2020-10-21</li><br/>
</ul>
