...
<li><span>冯某</span> 👍（0） 💬（0）<p>记录一下</p>2024-12-10</li><br/><li><span>ifelse</span> 👍（0） 💬（0）<p>学习打卡</p>2024-11-07</li><br/><li><span>骨汤鸡蛋面</span> 👍（0） 💬（0）<p>感谢大佬，新增一个python student类对应新增一个klass，new 一个student 对应vm new 一个HiObject。之前vm new的时候用的c++ 进程内存，有了基于一套分配回收理念的heap之后，new的klass&#47;HiObject 使用了heap空间，第一次将klass-oop，python对象，vm c++对象，heap空间管理都呼应上了。
极简版类似于，自己申请了一个byte[]，然后new 一个对象初始化放在在byte[] 上。</p>2024-07-17</li><br/>
</ul>
