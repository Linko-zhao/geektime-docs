...
<li><span>唯美</span> 👍（95） 💬（3）<p>快速解决，就只能改jvm内存配置，增大jvm新生代的大小，长期解决，引入NIO或AIO，netty 就是这么干的</p>2019-05-14</li><br/><li><span>QQ怪</span> 👍（38） 💬（3）<p>之前一直听别人说go语言很容易抗并发，原来是有个这么牛逼的轻量级线程在啊，并且理解了基本原理，感谢老师分享，为自己扩充了眼界了，为老师打call👍</p>2019-05-14</li><br/><li><span>韦</span> 👍（32） 💬（1）<p>每次创建一个线程高并发肯定OOM，1引入线程池控制创建线程的大小，通过压测得到比较合理的线程数量配置，2 需要在请求端增加一个限流模块，自我保护</p>2019-05-24</li><br/><li><span>245864982</span> 👍（16） 💬（1）<p>老师，那tomcat也是一个请求一个线程的吧？它是怎么解决的。是用线程池吗？</p>2019-11-28</li><br/><li><span>欢乐小熊</span> 👍（13） 💬（2）<p>Kotlin 支持协程, 并且实现了完善的调度策略, 可以考虑使用 Kotlin 作为替代方案</p>2019-09-30</li><br/><li><span>cricket1981</span> 👍（13） 💬（3）<p>网上查资料说java中的线程是内核空间的，轻量级线程属于用户空间的，是这样吗？另外轻量级线程是如何调度的？</p>2019-05-17</li><br/><li><span>考休</span> 👍（4） 💬（1）<p>go中的轻量级线程就是协程吧？</p>2019-11-06</li><br/><li><span>Sam</span> 👍（3） 💬（1）<p>老师，请问Java不支持轻量级线程，但是有Fibe，那是不是就可以用Fibe在实际项目中，然后相当于Java也支持轻量级线程了？</p>2019-08-01</li><br/><li><span>旅途</span> 👍（2） 💬（1）<p>老师 问一下 fiber并发这么牛 为什么tomcat不使用fiber呢</p>2020-03-01</li><br/><li><span>尔东橙</span> 👍（1） 💬（1）<p>老师，轻量级线程语言层次实现的，该怎么理解</p>2019-07-21</li><br/><li><span>苗</span> 👍（0） 💬（1）<p>用个队列限流是不是通用思路？</p>2020-06-20</li><br/><li><span>ly</span> 👍（0） 💬（1）<p>老师，能不能提供一个编译openjdk的方法，我在网上搜索了好多博客，按照他们说的步骤，都出现各种各样的问题，难道编译openjdk这么难？主要是长期用window系统，搞起好麻烦！</p>2019-10-09</li><br/><li><span>夕夕熊</span> 👍（0） 💬（1）<p>tomcat 、webLogic 用的是这种模式吗</p>2019-05-14</li><br/><li><span>colin</span> 👍（0） 💬（1）<p>我想试试Fiber，这个是不是要使用OpenJDK</p>2019-05-14</li><br/><li><span>~Wade</span> 👍（25） 💬（1）<p>有一个java库叫Quasar Fiber ，通过javaagent技术可以实现轻量级线程  
官网：http:&#47;&#47;www.paralleluniverse.co&#47;quasar&#47;</p>2019-06-21</li><br/>
</ul>
