...
（3）**xxx** 魔法函数，前后均有一个“双下划线” 代表python里特殊方法专用的标识，如 **init**() 代表类的构造函数。</p>2019-06-08</li><br/><li><span>shiziwen</span> 👍（21） 💬（5）<p>第二种方法，对于多重继承，如果有多个构造函数需要调用， 我们必须用传统的方法LRUCache.**init**(self) 。
