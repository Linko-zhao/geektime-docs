...
<li><span>HiNeNi</span> 👍（6） 💬（1）<p>老师，有空的时候能不能出一些宏的教程，声明宏还好，在网上一直没有找到比较好的过程宏的教程。因为之前接触过QT，了解到一些c++框架在用自己的方式（宏加上关键字扩展）对语言或程序的行为进行很有意义的扩展，所以感觉宏这一块还是大有可为的，不知道老师有空时能不能略授一二。</p>2021-12-15</li><br/><li><span>给我点阳光就灿烂</span> 👍（4） 💬（1）<p>老师，可不可以具体给一个项目代码，关于插件架构的，特别好奇这种架构是怎样实现的
</p>2021-12-15</li><br/><li><span>gnu</span> 👍（2） 💬（1）<p>没想到 rust 课程还藏有架构设计思想的 bonus！惊喜了</p>2022-01-02</li><br/><li><span>幻境之桥</span> 👍（1） 💬（2）<p>流水线那个例子 Context 会不会很复杂，所有 Plug 之间感觉只能通过这个 Context 交互</p>2021-12-16</li><br/><li><span>pedro</span> 👍（1） 💬（1）<p>过去二十年时间，敏捷宣言（Agile Manifesto）和精益创业（Lean startup）对软件社区最大的负面影响就是，一大堆外行或者并没有深刻理解软件工程的从业者，过分追求速度，过度曲解 MVP（Minimum Viable Product），而忽视了从起点出发前，必不可少的架构和设计功夫，导致大部分技术债实际上是架构和设计阶段的债务。

不能再认同了～</p>2021-12-15</li><br/><li><span>榴莲味山楂片</span> 👍（0） 💬（1）<p>努力消化</p>2022-10-02</li><br/><li><span>Geek_4ca442</span> 👍（0） 💬（1）<p>老师请教个问题：如果在 kvServer 中保存的是一个结构体，value字段是要存储的值。
