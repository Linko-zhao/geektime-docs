...
![](https://static001.geekbang.org/resource/image/32/81/32c5b165815109bf8bb088ea26840781.png?wh=1920%2A1345)
...
<li><span>huangshaoyan</span> 👍（3） 💬（1）<p>老师，对应的代码可以放到您的github上吗</p>2018-06-16</li><br/><li><span>许成浩</span> 👍（1） 💬（0）<p>老师，可以推荐几本区块链相关的书籍好吗？</p>2018-06-29</li><br/><li><span>峪五</span> 👍（0） 💬（1）<p>做事要有始有终呀. 后面都没实现完呢.  </p>2022-08-16</li><br/><li><span>杨家荣</span> 👍（0） 💬（0）<p>极客时间第二期
21天打卡行动 33&#47;21
...
6,代码编写 6 database,
7,代码编写 7 commands,
8,代码编写 8 基础类,</p>2020-02-07</li><br/><li><span>栐哥</span> 👍（0） 💬（0）<p>谢谢，请问区块链的APP是用什么开发语言做的呢？是用node.js吗？是用什么IDE开发的呢？我去下载安装</p>2020-01-10</li><br/><li><span>Eric</span> 👍（0） 💬（0）<p>陈老师，p2p network类，例子里是不是还没实现好？</p>2018-12-13</li><br/><li><span>肖水平</span> 👍（0） 💬（0）<p>老师，代码在mac上编译不通过</p>2018-06-20</li><br/>
</ul>
