...
4,锚定机制是一种去中心化的抵押机制;
5,比特股的核心代码是由 Cryptonomex 公司开源的石墨烯（Graphene）框架演变而来，它的主体代码是 C++ 编写的，里面使用了大量的 boost 库组件，如果你对石墨烯技术感兴趣，并且熟悉 C++，可以仔细研究一番。</p>2020-01-23</li><br/><li><span>小老鼠</span> 👍（0） 💬（0）<p>比特股钱包将用户密钥存储在本地浏览器上安全吗？比特股商用价值是炒股吗？</p>2019-12-10</li><br/><li><span>宇</span> 👍（0） 💬（0）<p>如果暴跌 50% 以上，系统会以一成的价格（强制平仓）卖出抵...
极客时间版权所有: https:&#47;&#47;time.geekbang.org&#47;column&#47;article&#47;6834

跌了50%以上，因为是两倍抵押，那么应该无论怎么卖都是亏的吧？</p>2019-03-19</li><br/><li><span>smith</span> 👍（0） 💬（0）<p>理论上bts可以到10万tps，其实就是分布式架构？</p>2018-06-12</li><br/><li><span>麻袋</span> 👍（0） 💬（0）<p>蛮有难度的，看来还要多阅读几次</p>2018-06-06</li><br/>
</ul>
