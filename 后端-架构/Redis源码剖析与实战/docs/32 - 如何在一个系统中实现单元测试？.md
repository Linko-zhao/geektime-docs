...
<li><span>neohope</span> 👍（1） 💬（0）<p>1、sds测试框架是用宏写的，定义在testhelp.h中，测试代码在sds.c中，sdsTest函数是测试入口函数
2、从“dict get $srv $property” 到 “::redis::__dispatch__”看了半天，加了几个puts才看明白
</p>2022-03-29</li><br/><li><span>王恒</span> 👍（0） 💬（0）<p>太感谢了。
搜索引擎都找遍了，都没找到讲redis的 tcl脚本怎么用的。在这终于找到了。</p>2022-03-10</li><br/>
</ul>
