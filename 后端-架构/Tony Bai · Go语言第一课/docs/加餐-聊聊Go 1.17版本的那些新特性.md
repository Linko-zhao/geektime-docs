...
<li><span>木木</span> 👍（3） 💬（2）<p>老师您好，我也想跑一下您的这个benchmark测试代码，请问文中的代码是完整代码么？以及go test -bench . 中的“-bench .”是什么意思？</p>2021-12-19</li><br/><li><span>言己</span> 👍（3） 💬（1）<p>性能测试示例代码，golang 的字符串拼接原来有这么多方式。</p>2021-12-17</li><br/><li><span>lesserror</span> 👍（2） 💬（2）<p>看了大白老师的这节课后，马上升级到了1.17版本。
...
If reproducibility with go 1.16 is not needed:
        go mod tidy -compat=1.17</p>2021-12-17</li><br/><li><span>大尾巴老猫</span> 👍（1） 💬（1）<p>后续是否会讲解如何搭建一套私有的开发环境？企业级应用开发，通常有一些安全合规相关的要求，使用go mod，不太可能直接从github或者gitee上引用，私有代码库通常也是需要身份验证的，这种情况下如何使用go get？</p>2021-12-21</li><br/><li><span>无名无姓</span> 👍（1） 💬（2）<p>go 1.18版本的泛型还是比较让人期待的</p>2021-12-19</li><br/><li><span>陈东</span> 👍（1） 💬（2）<p>按第7讲的第一段代码，能go run代码，但是logrus.Println 一直显示红色报错，尝试很多办法，解决
...
怎么解决，寻求老师帮助，谢谢。</p>2021-12-18</li><br/><li><span>功夫熊猫</span> 👍（1） 💬（1）<p>我已经被go mod的本地包的引入方式难受死了，为了能引入本地包，我不得不把我的代码提前上传到码云。</p>2021-12-17</li><br/><li><span>Calvin</span> 👍（1） 💬（1）<p>老师后面可以加餐说下 go 1.18 的新“工作区模式”特性吗？感觉和泛型一样，它也会是一个重要的新特性。</p>2021-12-17</li><br/><li><span>罗杰</span> 👍（1） 💬（0）<p>修剪的 go mod 依赖终于符合我的直觉了，刚开始使用 go mod 的时候，这种简接依赖真的让我很不理解，现在终于被修复了。</p>2021-12-18</li><br/>
</ul>
