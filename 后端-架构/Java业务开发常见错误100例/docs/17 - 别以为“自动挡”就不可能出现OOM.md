...
![](https://static001.geekbang.org/resource/image/d1/d2/d17fdb7d5123566312f7d3888ef82bd2.png?wh=1058%2A296)
...
![](https://static001.geekbang.org/resource/image/34/52/34a0fc90ac8be7a20cb295c14f06d752.png?wh=1096%2A280)
...
![](https://static001.geekbang.org/resource/image/b9/e9/b9bb8ef163a07a8da92e6e66a6dd55e9.png?wh=2386%2A572)
...
![](https://static001.geekbang.org/resource/image/0b/ee/0b310e7da83f272afdf51b345d8057ee.png?wh=1738%2A194)
...
![](https://static001.geekbang.org/resource/image/53/12/53546299958a4fecef5fd473a0579012.png?wh=2186%2A1056)
...
![](https://static001.geekbang.org/resource/image/0c/68/0c14d6aff749d74b3ee0e159e4552168.png?wh=2650%2A246)
...
<li><span>一个汉子~</span> 👍（27） 💬（3）<p>针对第二点，可以先compile，然后在内存中保存，脚本内容的hash作为key，compile结果作为value，用ConcurrentReferenceHashMap保存
同样的风险还出现在表达式框架aviator中</p>2020-04-18</li><br/><li><span>Darren</span> 👍（12） 💬（3）<p>试着回到下问题：
第一个：
...
第二种方法：GroovyShell设置为全局的，然后使用缓存，每次都是先从缓存中获取，获取不到了，在加载，然后更新缓存。</p>2020-04-20</li><br/><li><span>汝林外史</span> 👍（12） 💬（1）<p>1. 对于老师说的autoComplete的场景是不是Trie树更适合一些？
...
3. 对于问题1，应该是用软引用更好一些，用弱引用总是被gc回收就失去了缓存的意义。对于问题2不是很了解。</p>2020-04-20</li><br/><li><span>👽</span> 👍（9） 💬（2）<p>应该用哪种引用，首先考虑的肯定是四大引用的区别。
