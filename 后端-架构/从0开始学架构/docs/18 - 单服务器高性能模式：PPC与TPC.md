...
水平有限，望华仔指点下。</p>2018-06-08</li><br/><li><span>peison</span> 👍（31） 💬（5）<p>请教一个比较小白的问题…为什么说门户网站是海量连接常量请求的情况？海量连接下为什么会常量请求，一直想不通</p>2018-07-24</li><br/><li><span>孙晓明</span> 👍（21） 💬（4）<p>李老师，看完文章后查了一下bio和nio，还有一种aio，看的不是太明白，能麻烦您解答一下，并且它与nio的差别在哪里？</p>2018-06-22</li><br/><li><span>云学</span> 👍（20） 💬（1）<p>希望再多写几篇讲解单机性能优化，比如线程模型，数据库，网络等，猜测下一篇讲IO复用了吧</p>2018-06-07</li><br/><li><span>无聊夫斯基</span> 👍（18） 💬（5）<p>我无法想到ppc比tpc更适合的场景</p>2018-08-22</li><br/><li><span>胖胖的程序猿</span> 👍（17） 💬（4）<p>1. 海量连接（成千上万）海量请求：例如抢购，双十一等 2. 常量连接（几十上百）海量请求：例如中间件 3. 海量连接常量请求：例如门户网站 4. 常量连接常量请求：例如内部运营系统，管理系统
