...
<li><span>Meow</span> 👍（16） 💬（0）<p>oh my godsh, 这个专栏买的是真值，还追加 Go 的选学🥕</p>2021-01-20</li><br/><li><span>戈壁滩的骆驼草</span> 👍（4） 💬（0）<p>皓哥，太强了👍👍👍</p>2021-01-25</li><br/><li><span>Moonus</span> 👍（2） 💬（0）<p>示例代码，foo = make([]int, 5) 初始化少个:  =&gt;foo := make([]int, 5)</p>2021-07-17</li><br/><li><span>重生之蓝</span> 👍（2） 💬（0）<p>这一章真的很赞，作为半路出家学习go的码农，每个知识点都是容易忽略的问题，看了这个能避免不少因为对go理解不到位导致的程序错误或者性能问题。</p>2021-02-25</li><br/><li><span>特立独行的猪</span> 👍（1） 💬（0）<p>这就是面向对象编程方法的黄金法则——“Program to an interface not an implementation”。 这几个循序渐进的例子，看到这里突然就顿悟了</p>2021-09-13</li><br/><li><span>Andy</span> 👍（0） 💬（0）<p>最喜欢看到的就是这些图了，特别方便理解</p>2023-03-10</li><br/><li><span>老高活鱼</span> 👍（0） 💬（0）<p>Typo: `StringBuild` -&gt; `StringBuilder`</p>2023-02-19</li><br/><li><span>Andy</span> 👍（0） 💬（0）<p>我就非常喜欢用图说话，一图胜千言</p>2022-12-31</li><br/><li><span>limix</span> 👍（0） 💬（0）<p>函数，成员方法和接口之间的互动关系，解释到位了</p>2022-07-30</li><br/><li><span>陈琦</span> 👍（0） 💬（0）<p>学习到了</p>2022-04-04</li><br/><li><span>Groot</span> 👍（0） 💬（0）<p>关于接口完整性检查那块，直接将 s 声明为 Shape 类型的变量是不是也可以
