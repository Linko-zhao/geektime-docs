...
1&gt; 方法论：分清楚 _功能性需求_ 与 _非功能型需求_
之前是想到什么注意什么，往往做不到穷举。

2&gt; 一步一步地重构，其实解决的是自信问题：
做事要先解决思想问题，也就是心理问题：- 没有人能够一步到位地完美解决问题，优秀的代码是演进的，也就是说，代码结构不完美的状态是跳不过去的。- 我们始终聚焦在解决问题上，代码有问题非常正常。- 我们要带着成就感不断重构代码，而不是带着对自己否定的愧疚感，这非常重要。- 成就感让你追求卓越，愧疚感只是让你不想犯错(而这是做不到的)。</p>2020-02-22</li><br/><li><span>辣么大</span> 👍（20） 💬（5）<p>思考题：startRepeatedReport()多次调用，会启动多个线程，每个线程都会执行统计和输出工作。
