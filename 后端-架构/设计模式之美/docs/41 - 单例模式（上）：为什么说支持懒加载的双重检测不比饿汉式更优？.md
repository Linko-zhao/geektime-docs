...
老师，请问是哪个版本解决了这个问题呢?</p>2020-05-19</li><br/><li><span>鹤涵</span> 👍（1） 💬（1）<p>1. Spring中的一些连接工厂类，Service类都默认是单例模式 这些对象是一般消耗资源或者类似于工具类没有共享变量竞争问题。2. FileWritter设计成 static final的可以使用jvm类加载特性解决竞争问题。但是可测试性变差</p>2020-11-26</li><br/><li><span>skying</span> 👍（1） 💬（2）<p>争哥，你好！
